...
if uploaded_file is not None:
    ...
    num_valid_features = sum(~df[feature].isna().all() for feature in TRAINED_FEATURES)
    ...
    num_valid_features_after_scaling = sum(~df[feature].isna().all() for feature in TRAINED_FEATURES)

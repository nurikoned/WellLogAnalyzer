...
if uploaded_file is not None:
    ...
    # Check if all feature columns are entirely NaN
    if df[TRAINED_FEATURES].isna().all().all():
        st.error("All feature columns (GR, RHOB, RILD, DT, SP, SPOR) are missing or contain only NaN values. Prediction cannot proceed. Please upload an LAS file with at least one valid feature column.")
        st.stop()

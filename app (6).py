...
TRAINED_FEATURES = ['GR', 'RHOB', 'RILD', 'DT', 'SP']
...
try:
    ...
    st.error("Model file 'xgboost_model.pkl' not found. Please ensure the model file is in the same directory as this script.")
    st.stop()
...
if uploaded_file is not None:
    ...
    df = df[['DEPT'] + TRAINED_FEATURES]  # Assuming 'DEPT' is the depth column

    # Warn user if features are missing
    if missing_features:
